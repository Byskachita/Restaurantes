...
class TiposComidasController < ApplicationController
  ...
  def editar
    ...
    # @tipo_comida = TipoComida.find(param[:id])
  end
  ...
  def guardar
    ...
    if @tipo_comida.save # pregunta por las validaciones, SI pasa todas, se guarda, SINO, agregar un hash de errorres
